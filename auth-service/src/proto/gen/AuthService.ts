...
import type { CreateUserPasswordRequest as _CreateUserPasswordRequest, CreateUserPasswordRequest__Output as _CreateUserPasswordRequest__Output } from './CreateUserPasswordRequest';
import type { CreateUserPasswordResponse as _CreateUserPasswordResponse, CreateUserPasswordResponse__Output as _CreateUserPasswordResponse__Output } from './CreateUserPasswordResponse';
...
export interface AuthServiceClient extends grpc.Client {
  ...
  CreateUserPassword(argument: _CreateUserPasswordRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_CreateUserPasswordResponse__Output>): grpc.ClientUnaryCall;
  CreateUserPassword(argument: _CreateUserPasswordRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_CreateUserPasswordResponse__Output>): grpc.ClientUnaryCall;
  CreateUserPassword(argument: _CreateUserPasswordRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_CreateUserPasswordResponse__Output>): grpc.ClientUnaryCall;
  CreateUserPassword(argument: _CreateUserPasswordRequest, callback: grpc.requestCallback<_CreateUserPasswordResponse__Output>): grpc.ClientUnaryCall;
  createUserPassword(argument: _CreateUserPasswordRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_CreateUserPasswordResponse__Output>): grpc.ClientUnaryCall;
  createUserPassword(argument: _CreateUserPasswordRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_CreateUserPasswordResponse__Output>): grpc.ClientUnaryCall;
  createUserPassword(argument: _CreateUserPasswordRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_CreateUserPasswordResponse__Output>): grpc.ClientUnaryCall;
  createUserPassword(argument: _CreateUserPasswordRequest, callback: grpc.requestCallback<_CreateUserPasswordResponse__Output>): grpc.ClientUnaryCall;
  ...
  GetUserPasswordByUserId(argument: _GetUserPasswordByUserIdRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_GetUserPasswordByUserIdResponse__Output>): grpc.ClientUnaryCall;
  GetUserPasswordByUserId(argument: _GetUserPasswordByUserIdRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_GetUserPasswordByUserIdResponse__Output>): grpc.ClientUnaryCall;
...
export interface AuthServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  CreateUserPassword: grpc.handleUnaryCall<_CreateUserPasswordRequest__Output, _CreateUserPasswordResponse>;
...
export interface AuthServiceDefinition extends grpc.ServiceDefinition {
  ...
  CreateUserPassword: MethodDefinition<_CreateUserPasswordRequest, _CreateUserPasswordResponse, _CreateUserPasswordRequest__Output, _CreateUserPasswordResponse__Output>
